...
import { useHabitsStore } from '@/components/stores/habitsStore';
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {habit.streak > 0 && (
                        <div className="flex items-center gap-2 text-orange-600">
                          ...
                          {habit.streak === habit.best_streak && habit.best_streak > 1 && (
                      ...
                      <div>
                        ...
                        <div className="flex gap-1">
                          {last7Days.map(day => {
                            ...
                            const isCompleted = habit.checkedToday && isToday;
        ...
        <Dialog open={!!editingHabit} onOpenChange={(open) => {
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="edit-reminder_time">Reminder Time</Label>
                <Input
