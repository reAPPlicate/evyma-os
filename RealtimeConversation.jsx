...
export default function RealtimeConversation({ accentColor, isOpen, onClose, pageContext }) {
    ...
    try {
      ...
      ws.onmessage = (event) => {
        ...
        if (data.type === 'session.created') {
          ...
          const contextInstructions = pageContext?.pageGreeting 
            ? `You are Evyma, a warm and supportive AI life coach. The user is currently on the ${pageContext.route} page. Start by greeting them with: "${pageContext.pageGreeting}" Keep responses concise and conversational. Focus on helping them with ${pageContext.route.replace('/', '')} related tasks.`
            : 'You are Evyma, a warm and supportive AI life coach. Start the conversation by greeting the user warmly and asking how you can help them today. Keep responses concise and conversational.';
